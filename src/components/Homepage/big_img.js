        ...
        <>
            <div className='ml-4 mr-4  relative aspect-[10/5] md:aspect-[10/6] sm:aspect-[9/13] flex items-start flex-col justify-center '>
                <div className='  relative ml-10 lg:ml-0'>
                    <h1 className=' font-bold text-gray-900  text-9xl  lg:text-8xl'>Looking for a place?</h1>
                    <h1 className='font-bold text-gray-900  text-9xl  lg:text-8xl'>Search <span className='text-purple-500'>now!</span></h1>
                </div>
