...
function Header() {
  ...
  return (
    ...
    <div className="m-3 ml-4 mr-4 rounded-t-2xl flex bg-gray-900 h-12 ">
      <span className="text-white font-bold pt-2 pl-5">Follow Us</span>
    ...
    <div className="m-3 ml-4 mr-4 mb-10 rounded-b-3xl flex bg-gradient-to-r from-purple-600 to-purple-400 z-10 bottom-4 relative">  
      ...
      <div className="w-1/6">
        <div className="md:hidden flex ">
          <button type="button" className="mr-auto ml-auto shadow-lg transition duration-300 ease-in-out bg-gray-900 font-bold text-lg p-3 pl-4 pr-4 rounded-3xl text-white m-5 space-x-2 hover:bg-gray-700">
          ...
          {({ open }) => ( 
            <>
              <Popover.Button className=" mr-auto ml-auto block m-5 rounded-3xl bg-purple-900 text-white hover:bg-gray-700 shadow-lg transition duration-500 ease-in-out sm:mr-5">
                ...
                <Popover.Panel className="border-3 border-purple-600  absolute z-30 w-full left-0 top-0 bg-white h-80 rounded-b-2xl">
                  <div className="relative">
                    ...
                    <div className="">
                      <button className="bg-purple-700 text-white mr-auto ml-auto block  px-40 m-4 p-3  text-lg font-medium rounded-full">
                        Sign Up
                      </button>
                    </div>
                  </div>
