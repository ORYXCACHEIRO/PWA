          ...
          <div className="md:hidden h-full">
            ...
            <div className="hidden h-full">
              <div className="flex justify-end items-center w-max space-x-2 pr-10 xl:pr-2 lg:pr-8 float-right gap-5 xl:gap-0  h-full">
                ...
                <button type="button" className="flex items-center justify-center w-max shadow-lg transition duration-300 ease-in-out bg-red-700 font-bold text-lg p-5 pl-5 pr-5  rounded-3xl text-white space-x-1 hover:bg-gray-700 lg:mr-9">
